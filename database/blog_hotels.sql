...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 09, 2020 lúc 07:24 AM
...
CREATE TABLE `categories` (
  ...
  `cat_created_at` int(11) DEFAULT NULL,
  `cat_updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `comments` (
  ...
  `com_created_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `media` (
  ...
  `med_created_at` int(11) DEFAULT NULL,
  `med_updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `menu` (
  ...
  `mnu_created_at` int(11) DEFAULT NULL,
  `mnu_updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tags` (
  ...
  `tag_created_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
